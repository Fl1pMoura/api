...
let TransactionsController = class TransactionsController {
    ...
    findAll(userId, month, year, bankAccountId, transactionType) {
...
__decorate([
    ...
    __param(4, (0, common_1.Query)("transactionType", new OptionalParseEnumPipe_1.OptionalParseEnumPipe(Transaction_1.TransactionType))),
    __metadata("design:type", Function),
